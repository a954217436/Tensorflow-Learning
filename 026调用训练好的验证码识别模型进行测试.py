# -*- coding: utf-8 -*-
"""
Created on Wed Apr 17 09:15:56 2019
...
BATCH_SIZE = 1
#TFRecord 文件存储路径
TFRECORD_FILE = 'C:/Users/Sean/py/tensorflow/captcha/test.tfrecords'
...
with tf.Session() as sess:
    ...
    prediction0 = tf.argmax(prediction0, axis=1)
    ...
    saver.restore(sess, 'C:/Users/Sean/py/tensorflow/captcha/models/crack_captcha.model-6000')
