...
#            
            ...
            pred = node_lookup.id_to_string(top_k[0])
            cv2.putText(img, pred, (5,20), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (0,0,255))
            cv2.imshow(file, img)
            cv2.imwrite('images/answer/'+file, img)
            print()
