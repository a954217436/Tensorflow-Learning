...
#在训练前重置默认模型，如果不加，会报错，，或者重启IDE或kernel。参考： https://blog.csdn.net/u010327061/article/details/84078583
...
with tf.Session() as sess:
    ...
    print("Init Testing Accuracy: " + str(acc))
    #载入模型
    saver.restore(sess, 'net/my_net.ckpt')
    acc = sess.run(accuracy, feed_dict={x:mnist.test.images, y:mnist.test.labels, keep_prob:1.0})
    print("Model Testing Accuracy: " + str(acc))
